...
@section('content')
    ...
    <div class="container">
        <div class="row">      
            ...
            {{-- <div class="col-md-6">                
                <a href="{{ route('admin.assignemnts.create') }}" class="btn btn-primary pull-right"><span class="fa fa-plus"></span> Add Assignment</a>
            </div> --}}    
        </div>
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>
                            ...
                            <a type="button" class="btn btn-primary btn-md" href="{{ route('admin.assignments.edit', $assignment->id) }}"><i class="fa fa-pencil"></i></a>
                            <a type="button" class="btn btn-danger btn-md" href="{{ route('admin.assignments.delete', $assignment->id) }}" onclick="return confirm('Are you sure')"><i class="fa fa-trash"></i></a>
                        </td>
                    </tr>
                    @endforeach
                    @endif                 
